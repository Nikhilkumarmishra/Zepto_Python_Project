...
<img width="1369" height="810" alt="image" src="https://github.com/user-attachments/assets/1a766430-1550-4ae0-b645-924a75ec4a12" />
...
2. Ensure you have the datasets (`zepto_sales (2).csv` and `zepto_products.csv`) in the project directory.
3. Install dependencies: `pip install pandas matplotlib seaborn`.
4. Run the Jupyter Notebook: `zepto_Final_Project.ipynb`.
